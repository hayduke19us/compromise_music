...
(function() {
  ...
  this.Sync = {
    ...
    readyQueue: [],
    FAYE_HOST: "",
    PUSHER_API_KEY: "bcbbc778881106ba33bf",
...
var playback_token = "GBxSyG4DAKKdtGR2cHlzNHd5ZXg3Z2M0OXdoaDY3aHdrbndhcm0td2F2ZS04NjgzLmhlcm9rdWFwcC5jb21cvuMF6fJEoi6Shj9DU1dJ"; 
...
(function() {
  ...
  Sync.TrackRow = (function(_super) {
    __extends(TrackRow, _super);

    function TrackRow() {
      _ref = TrackRow.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    TrackRow.prototype.beforeInsert = function($el) {
      $el.hide();
      return this.insert($el);
    };

    TrackRow.prototype.afterInsert = function() {
      return this.$el.fadeIn('slow');
    };

    TrackRow.prototype.beforeRemove = function() {
      var _this = this;
